...
public class ConfiguracionDepartamento {
    ...
    public int getPuerto() {
        return Integer.parseInt(properties.getProperty("departamento.puerto", "7001"));
    }
    ...
    public int getTimeout() {
        return Integer.parseInt(properties.getProperty("departamento.timeout", "5000"));
    }
    ...
    public int getServidorCentralPuerto() {
        return Integer.parseInt(properties.getProperty("servidor.central.puerto", "6000"));
    }
    ...
    public int getServidorCentralTimeout() {
        return Integer.parseInt(properties.getProperty("servidor.central.timeout", "5000"));
    }
