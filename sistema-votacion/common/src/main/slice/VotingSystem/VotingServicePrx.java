...
{
    default boolean enviarVotoVotante(String mesaId, Voto voto, Votante votante)
    {
        return enviarVotoVotante(mesaId, voto, votante, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean enviarVotoVotante(String mesaId, Voto voto, Votante votante, java.util.Map<String, String> context)
    {
        return _iceI_enviarVotoVotanteAsync(mesaId, voto, votante, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> enviarVotoVotanteAsync(String mesaId, Voto voto, Votante votante)
    {
        return _iceI_enviarVotoVotanteAsync(mesaId, voto, votante, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> enviarVotoVotanteAsync(String mesaId, Voto voto, Votante votante, java.util.Map<String, String> context)
    {
        return _iceI_enviarVotoVotanteAsync(mesaId, voto, votante, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_enviarVotoVotanteAsync(String iceP_mesaId, Voto iceP_voto, Votante iceP_votante, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "enviarVotoVotante", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(iceP_mesaId);
                     ostr.writeValue(iceP_voto);
                     ostr.writeValue(iceP_votante);
    ...
    default int getTotalVotos()
    {
        return getTotalVotos(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int getTotalVotos(java.util.Map<String, String> context)
    {
        return _iceI_getTotalVotosAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> getTotalVotosAsync()
    {
        return _iceI_getTotalVotosAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> getTotalVotosAsync(java.util.Map<String, String> context)
    {
        return _iceI_getTotalVotosAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_getTotalVotosAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getTotalVotos", null, sync, null);
